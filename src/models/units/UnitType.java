...
public enum UnitType {
    ...
    HORSEMAN("Horseman", 80, CombatType.MOUNTED,
             12, 0, 1, 4,
            StrategicResource.getRequiredResourceHashMap(StrategicResource.HORSE), Technology.HORSEBACK_RIDING),
    ...
    CAVALRY("Cavalry", 260, CombatType.MOUNTED,
             25, 0, 1, 3,
            StrategicResource.getRequiredResourceHashMap(StrategicResource.HORSE), Technology.MILITARY_SCIENCE),
    ...
    private UnitType(String name, int cost, CombatType combatType, int combatStrength, int rangedCombatStrength, int range, int movementSpeed,
