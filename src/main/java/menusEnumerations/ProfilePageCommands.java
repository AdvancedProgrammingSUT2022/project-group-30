...
public enum ProfilePageCommands {
    ...
    CHANGE_PASSWORD_PATTERN_1(
            "profile change ((--password)|(-p)) (((--current)|(-c)) (?<currentPassword>\\S+) ((--new)|(-n)) (?<newPassword>\\S+))"),
    CHANGE_PASSWORD_PATTERN_2(
            "profile change ((--password)|(-p)) (((--new)|(-n)) (?<newPassword>\\S+) ((--current)|(-c)) (?<currentPassword>\\S+))"),
