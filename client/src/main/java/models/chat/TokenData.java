...
public class TokenData {
    ...
    private boolean shouldUpdatePrivateChat;
    ...
    public boolean isShouldUpdatePrivateChat() {
        return shouldUpdatePrivateChat;
    }

    public void setShouldUpdatePrivateChat(boolean shouldUpdatePrivateChat) {
        this.shouldUpdatePrivateChat = shouldUpdatePrivateChat;
    }
}
