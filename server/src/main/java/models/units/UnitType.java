...
public enum UnitType implements Producible, EnumInterface {
    @SerializedName("Enum models.unit.UnitType Archer")
    ARCHER("Archer", 70, CombatType.ARCHERY,
            4, 6, 2, 2,
            StrategicResource.getRequiredResourceHashMap(), Technology.ARCHERY),
    @SerializedName("Enum models.unit.UnitType Chariot Archer")
    ...
    @SerializedName("Enum models.unit.UnitType Horseman")
    ...
    @SerializedName("Enum models.unit.UnitType Swordsman")
    ...
    @SerializedName("Enum models.unit.UnitType Longswordsman")
